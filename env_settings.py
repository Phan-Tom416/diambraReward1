...
class WrappersSettings:
    ...
    superbar_wrapper: bool = False
    custom_stun_wrapper: bool = False
    block_wrapper: bool = False
    super_hit_wrapper: bool = False
    opp_super_hit_wrapper: bool = False
    time_penalty_wrapper: bool = False
    win_wrapper: bool = False
    no_hit_wrapper: bool = False
